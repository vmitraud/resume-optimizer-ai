...
export const translations = {
  en: {
    ...
    preview: {
      ...
      translateFailFallback: "Failed to translate the resume.",
  ...
  pt: {
    ...
    preview: {
      ...
      translateFailFallback: "Falha ao traduzir o currículo.",
  ...
  de: {
    ...
    preview: {
      ...
      languageCardTitle: "Sprache",
      translateFailFallback: "Der Lebenslauf konnte nicht übersetzt werden.",
